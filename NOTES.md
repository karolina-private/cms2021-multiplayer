...
Status: BepInEx IL2CPP plugin project and tested network-domain foundation are implemented; published source is next.
Next: Test the plugin against the owner's specific CMS2021 + BepInEx installation, then implement actual scene/game hooks.
